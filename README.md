...
👉 **Streamlit App:** https://telcocustomer-churn-prediction-using-ml.streamlit.app/

📌 Enter customer details and click “Predict” to see results in real-time.
...
2. Data is preprocessed (label encoding + scaling)
3. Trained ML model processes input data
4. Model predicts churn probability
5. Result is displayed in Streamlit app:
   - ✅ Customer will Stay  
